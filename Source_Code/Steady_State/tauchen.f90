...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
    ...
    integer,  intent(in) :: n           ! # of states
    real(dp), intent(in) :: amean       ! Mean of innovation
    real(dp), intent(in) :: rho         ! Persistence
    real(dp), intent(in) :: sigmaeps    ! Std.dev of innovation
    real(dp), intent(in) :: xm          ! Range of coverage of Discrete States
    real(dp), intent(out), dimension(n) :: Z    ! Shock Value
    real(dp), intent(out), dimension(n,n) :: Zprob  ! Transition Matrix
